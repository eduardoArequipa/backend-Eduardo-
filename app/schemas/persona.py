...
class PersonaBase(BaseModel):
    ...
    ci: Optional[str] = Field(None, min_length=1, max_length=20, description="Cédula de Identidad, debe ser única.")
...
class PersonaCreate(PersonaBase):
    ci: str = Field(..., min_length=1, max_length=20, description="Cédula de Identidad, debe ser única.")
    telefono: str = Field(..., min_length=7, max_length=20, description="El teléfono debe tener solo números y puede incluir el prefijo de país.")
...
class PersonaUpdate(PersonaBase):
    ...
    apellido_paterno: Optional[str] = Field(True, min_length=3, max_length=100)
